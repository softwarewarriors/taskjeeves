...
Software Warriors development team follows the latest security best practices when
developing software, and automates security testing throughout development
lifecycle whenever possible.

Security is integrated into all phases of Software Warriors product development lifecycle,
including:
...
Details about the Software Warriors software application architecture and
security are documented on the [product development / engineering wiki](https://softwarewarriors.github.io/).

## Policy Statements

Software Warriors policy requires that:

(a) Software Warriors software engineering and product development is required to follow
...
third-party components and dependencies included in Software Warriors software products.
